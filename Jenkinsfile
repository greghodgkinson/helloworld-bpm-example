     ...
     stages {              
           stage('Checkout'){
            ...
            stage('Trigger UCD Dev Deploy') {			
                  steps {			       				 			
                        sh '/buildconductor/bpm/run-automation.sh requestUcdDeploy "Demo Applications System (BPM, IIB, WDP, WAS)" "Dev" "Deploy HelloWorld Mediation BPMAdvanced8.5 (Latest Version)" admin admin ${BUILD_URL} https://10.0.10.47:8446'            			
